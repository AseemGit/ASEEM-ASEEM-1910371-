...
$action = !empty($_REQUEST['action']) ? $_REQUEST['action'] : '';//action for perform order page
?>
<!DOCTYPE html>
<html>
<head>
...
<title>
<?php if($pageName=='buying'){//set title according to page?>
Foodie : Buying
...
<body>
  ...
  <div class="main-header">
    <div class="container">
    <?php if($action=='print'){//set condition if action print?>
      ...
      <div class="nav-wrap">
        <nav class="nav-desktop">
          <ul class="menu-list">
            ...
            <li><a href="cheatsheet.pdf" target="_blank">CHEATSHEET</a></li>
          </ul>
        </nav>
      </div>
    </div>
